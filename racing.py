...
class Game():
    ...
    def display_menu(self,screen):
        ...
        self.draw_text(screen,"PyCar: Racing Car Game", self.font_40,draw_x,draw_y + 50,BLACK)
        self.draw_text(screen,"Score: " + str(self.score),self.font_40,draw_x,draw_y + 150,WHITE)
        self.draw_text(screen,"Press Space Key to Strat!",self.font_30,draw_x,draw_y + 200,RED)
