...
class Rock(pygame.sprite.Sprite):
    def __init__(self):
        ...
        rock_images_path = resource_path('assets/t6.png')
        self.image = pygame.image.load(rock_images_path)
        self.rect = self.image.get_rect()
        self.rect.x = 0
        self.rect.y = 0
    ...
    def update(self):
        if self.a == 1:
            ...
            self.rect.y = random.randint(0,440)
            self.a = 0
...
#            sleep(1)
    ...
    def display_menu(self, screen):
        ...
        self.draw_text(screen, '제 2333년 우주 양궁대회',
    ...
    def display_frame(self, screen):
        screen.fill(BLACK)
        self.draw_text(screen, '맞힌 과녁: {}'.format(self.shot_count),
