...
class Spaceship(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.cerntery = self.rect.centery
    def set_pos(self,x,y):
        self.rect.x = x - self.centerx
        self.rect.y = y - self.cerntery
...
class Game():
    ...
    def display_menu(self,screen):
        ...
        self.draw_text(screen,'우주 암석 피하기',self.font_70,draw_x,draw_y,WHITE)
